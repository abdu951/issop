...
export default function Home() {
   ...
   return (
        <div className="bg-black flex flex-col items-center pb-80 text-center text-white">
                ...
                <nav className="flex justify-between items-center px-4 md:px-16 lg:px-24 xl:px-32 py-3.5 border-b border-slate-200/20 w-full">
                    ...
                    <div>
                        <button onClick={() => router.push("/login")} className="text-white hover:bg-gray-300 px-6 md:px-8 py-2.5 rounded-full font-medium transition">
                        Sign in
                    </button>
                    <button onClick={() => router.push("/register")} className="bg-white text-slate-800 hover:bg-gray-300 px-6 md:px-8 py-2.5 rounded-full font-medium transition">
                        Sign up
                    </button>
                    </div>
                ...
                <h1 className="font-berkshire text-[45px]/[52px] md:text-6xl/[65px] mt-6 max-w-4xl pt-20 font-semibold">
